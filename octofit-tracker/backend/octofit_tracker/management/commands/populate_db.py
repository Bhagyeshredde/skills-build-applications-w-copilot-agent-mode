...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create activities
        Activity.objects.create(user='Iron Man', type='Running', duration=30, date='2026-03-13')
        Activity.objects.create(user='Captain America', type='Cycling', duration=45, date='2026-03-13')
        Activity.objects.create(user='Thor', type='Swimming', duration=60, date='2026-03-13')
        Activity.objects.create(user='Superman', type='Running', duration=50, date='2026-03-13')
        Activity.objects.create(user='Batman', type='Cycling', duration=40, date='2026-03-13')
        Activity.objects.create(user='Wonder Woman', type='Swimming', duration=55, date='2026-03-13')
